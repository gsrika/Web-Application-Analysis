...
public class firstTest {
  ...
  public void testFirst() throws Exception {
    ...
    driver.findElement(By.name("member_login")).sendKeys("newuser1");
    driver.findElement(By.name("member_password")).clear();
    driver.findElement(By.name("member_password")).sendKeys("newuser1");
    driver.findElement(By.name("member_password2")).clear();
    driver.findElement(By.name("member_password2")).sendKeys("newuser1");
    ...
    driver.findElement(By.name("email")).sendKeys("srikanthiniiit@gmail.com");
    driver.findElement(By.name("address")).clear();
    driver.findElement(By.name("address")).sendKeys("2676 Maganolia");
    driver.findElement(By.name("phone")).clear();
    driver.findElement(By.name("phone")).sendKeys("213");
    new Select(driver.findElement(By.name("card_type_id"))).selectByVisibleText("Visa");
    driver.findElement(By.name("card_number")).clear();
    driver.findElement(By.name("card_number")).sendKeys("21345");
    ...
    String userName=driver.findElement(By.xpath("//td[2]/font")).getText();
    userName=userName.trim();
    assertEquals("srikanth", userName);
    assertEquals("newuser1", driver.findElement(By.xpath("//tr[2]/td[2]/a/font")).getText());
  }
